	...
	display: none;
		...
		<ul	class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion "
			...
			<li class="nav-item"><a class="nav-link"
				href="<%= request.getContextPath() %>/or/ad/li"> <i
					class="fas fa-regular fa-box"></i> <span>주문관리</span></a></li>

			<!-- Nav Item - Produce -->
			<li class="nav-item"><a class="nav-link"
				href="<%= request.getContextPath() %>/pr/ad/al"> <i
					class="fas fa-solid fa-box"></i> <span>상품관리</span></a></li>
			...
			<!-- Nav Item - Charts -->
			<li class="nav-item"><a class="nav-link"
				href="<%= request.getContextPath() %>/me/ad/lC"> <i
					class="fas fa-solid fa-user"></i> <span>일반회원 관리</span></a></li>

			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link"
				href="<%= request.getContextPath() %>/me/ad/lS"> <i
					class="fas fa-solid fa-users"></i> <span>판매자 관리</span></a></li>
