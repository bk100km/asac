	...
	<div id="wrapper">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<c:forEach items="${memberList}" var="member">
										<tr id="infoBtn" data-mid="${member.mid}">
											<td>${member.mid}</td>
											<td>${member.mname}</td>
											<td>${member.mphone}</td>
										</tr>
		...
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				<form class="memberClientInsert" id= "memberClientInsert" name="memberClientInsert" action="./ci" method="post">

					<label for="mid">아이디 <span class="text-danger">*</span></label> 
					<div class="input-group">
					<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
						<input type="text"
							class="form-control" name = "mid" id="mid" value=""
					...
					<div class="mb-3">
						<label for="mname">이름 <span class="text-danger">*</span></label> <input type="text"
							class="form-control"  name = "mname" id="mname" value=""
					...
					<div class="mb-3">
						<label for="mbirth">생년월일 <span class="text-danger">*</span></label> <input type="text"
							class="form-control" name = "mbirth" id="mbirth" value=""
		            ...
		            <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i><i class="mhpLabel"> &nbsp; (010) </i></span>
						<input type="tel"
							class="form-control"  name = "mphone" id="mphone" value=""
					...
					<input type="email"
							class="form-control" name="mmail" id="mmail" value=""
					...
					<input type="text" class="form-control" name="maddrd" id="maddrd" value=""
