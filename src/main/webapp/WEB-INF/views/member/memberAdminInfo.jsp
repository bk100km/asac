...
<br><br>
	...
	<div class="input-form-background row">
			...
			<h2>내 정보</h2>
					...
					<div><button type="button" onclick="location.href='http://localhost:8080/me/se/up'" class="btn btn-default">수정하기</button> &nbsp;
					<button type="button" onclick="location.href='http://localhost:8080/me/ad/in'" class="btn btn-default"> 메인으로</button>
		</div>
		</div>
		</div>
	</div>
