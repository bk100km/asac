...
function fn_prev(page, range, rangeSize, listSize, searchType, keyword) {	
	...
	var range = range - 1;
	var searchType = '${searchSe.searchType}';
	var keyword = '${searchSe.keyword}';
	var url = "la";
	url = url + "?page=" + page;
	url = url + "&range=" + range;
...
<div class="container-xl">
                    ...
                    <div class="col-lg-3 col-sm-12">
                        <div class="show-entries">
                            <span>상품 목록 갯수</span>
								...
								<option value="10"
									<c:if test="${productPagingSe.getListSize() == 10 }">selected="selected"</c:if>>10개</option>
								<option value="15"
									<c:if test="${productPagingSe.getListSize() == 15 }">selected="selected"</c:if>>15개</option>
								<option value="20"
									<c:if test="${productPagingSe.getListSize() == 20 }">selected="selected"</c:if>>20개</option>
								</select>
                        </div>
                    </div>
    ...
    <div class="clearfix">
		<ul class="pagination">
			<c:if test="${productPagingSe.prev}">
				<li class="page-item"><a class="page-link" href="#"
					onClick="fn_prev('${productPagingSe.page}', '${productPagingSe.range}', '${productPagingSe.rangeSize}', '${productPagingSe.listSize}', 
					'${searchSe.searchType}', '${searchSe.keyword}')">이전</a>
				</li>
			</c:if>
			<c:forEach begin="${productPagingSe.startPage}" end="${productPagingSe.endPage}" var="pcode">
				<li
					class="page-item <c:out value="${productPagingSe.page == pcode ? 'active' : ''}"/> ">
					<a class="page-link" href="#" onClick="fn_pagination('${pcode}', '${productPagingSe.page}', '${productPagingSe.range}', '${productPagingSe.rangeSize}', '${productPagingSe.listSize}'
					 ,'${searchSe.searchType}', '${searchSe.keyword}')">${pcode} </a>
				</li>
			</c:forEach>
			<c:if test="${productPagingSe.next}">
				<li class="page-item"><a class="page-link" href="#"
					onClick="fn_next('${productPagingSe.range}', '${productPagingSe.range}', '${productPagingSe.rangeSize}', '${productPagingSe.listSize}', 
					'${searchSe.searchType}', '${searchSe.keyword}')">다음</a>
				</li>
			</c:if>
		</ul>
	</div>
