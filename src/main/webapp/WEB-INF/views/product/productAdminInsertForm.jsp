...
<div class="container">
	<form class="productAdminInsert" id="productAdminInsert" name="productAdminInsert" action="./in" method="post">
		...
		<div class="col-md-6 mb-3">
			<input type="submit" class="btn btn-default btn-lg btn-block" id="productAdminInsert" value="상품 추가"> </div>
		<div class="col-md-6 mb-3">
			<input type="button" class="btn btn-default btn-lg btn-block" id="productAdminInsert" onclick="goBack()" title="취소" value="취소"></div>			
	</form>					
<div class="space">&nbsp;</div>
<div class="space">&nbsp;</div>
</div>
